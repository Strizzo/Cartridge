...
install_to_device() {
    ...
    info "Keeping the device BOOT partition and stock splash unchanged."
...
main() {
    ...
    # Copy payload only. Boot integration is installed on the running Linux
    # filesystem through setup-primary.py; never edit ext4 through raw macOS I/O.
    ...
    echo "  2. Launch Cartridge from EmulationStation > Options > Tools"
    echo "  3. Run Setup Cartridge Boot once to make it the primary launcher"
    echo ""
